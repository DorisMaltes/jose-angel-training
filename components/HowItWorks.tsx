const steps = [
  {
    ...
    desc: 'Tips de técnica, errores comunes, resultados de alumnos y contenido educativo sobre halterofilia y preparación física. Ahí empieza el proceso.',
    icon: '📱',
    cta: null,
  },
  {
    ...
    desc: 'No es regalar el servicio — es demostrar expertise. El cliente sale convencido de que necesita el plan. Evaluamos tu nivel, tus metas y tus limitaciones.',
    icon: '🔍',
    highlight: true,
    cta: null,
  },
  {
    number: '03',
    title: 'Plan Básico',
    subtitle: 'Primera compra de bajo riesgo',
    desc: 'El cliente prueba sin gran compromiso económico. La calidad del servicio hace el resto. Comienzas a ver resultados desde las primeras semanas.',
    icon: '📋',
    cta: null,
  },
  {
    number: '04',
    title: 'Upsell Natural al Pro',
    subtitle: 'Resultados = Fidelización',
    desc: 'Una vez que el cliente ve resultados, sube de plan. La retención es el motor del ingreso recurrente. Tu éxito es nuestro éxito.',
    icon: '📈',
    cta: null,
  },
]
